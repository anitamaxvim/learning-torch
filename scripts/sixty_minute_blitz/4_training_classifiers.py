...
# 2. Define a Convolutional Neural Netwok
...
for epoch in range(epochs):  # loop over entire dataset
    running_loss = 0.0
    for i, data in enumerate(train_loader, 0):  # loop over batches
...
save_path = "models/cifar_net.pth"
